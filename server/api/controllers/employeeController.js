...
const { readEmployee, deleteEmployees, readCharges, createEmployee } = require('../services/employeeService');
...
module.exports = { getEmployee, deleteEmployee, getCharges, newEmployee }