const { productGetDB, productPostDB, imageProductGetDB, productDeleteDB, productUpdateDB } = require('../db/productDB');
...
module.exports = {
    readProduct, createProduct, readImageProduct, deleteProduct, updateProduct
};