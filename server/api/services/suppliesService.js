const { supplyPostDB, suppliesGetDB, suppliesWithStockGetDB, supplyUpdateDB } = require('../db/suppliesDB');
...
module.exports = { createSupply, readTypeSupply, readSupplies, readSuppliesWithStock, modifySupply };