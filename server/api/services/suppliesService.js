const { supplyPostDB, suppliesGetDB, suppliesWithStockGetDB,
    supplyUpdateDB, supplyDeleteDB, suppliesUpdateStockDB } = require('../db/suppliesDB');
...
module.exports = {
    ...
    modifySupply, supplyDelete, modifySupplyStock
};