        ...
        <div className='buttons'>
            <BeShowed show={props.labelJump}>
                <BeShowed show={props.ready}>
                    ...
                    <button className='btn btn-light cancel' onClick={props.actionJump}>{props.labelJump}</button>
                ...
                <BeShowed show={!props.ready}>
                    ...
                    <button className='btn btn-light cancelSendNotOk' onClick={actionNotOK}>{props.labelJump}</button>
                    <button className='btn btn-light cancel' onClick={props.actionCancel}>Cancelar</button>
                </BeShowed>
            </BeShowed>
            <BeShowed show={!props.labelJump}>
