...
import FlavorsToSellTablePagination from './FlavorsToSellTablePagination';
import CleanFilters from 'common/CleanFilters';

const FlavorsToSellTableSearch = ({
    currentElements,
    flavorTypes,
    flavorFamilies,
    handleRemoveFlavor,
    ...
    return (
        <>
            ...
            <FlavorsToSellTablePagination filteredElements={filteredElements} handleRemoveFlavor={handleRemoveFlavor} />
        </>
    )
};

export default FlavorsToSellTableSearch;
