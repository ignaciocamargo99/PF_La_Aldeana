...
const TablePagination = ({ columnsHeaders, currentElements, handleEdit, handleDelete }) => {
    ...
    const pageElements = currentElements.slice(indexOfFirstElement, indexOfLastElement);
