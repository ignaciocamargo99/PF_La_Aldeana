...
export default function DataAssistance(props) {
    ...
    useEffect(() => {
        ...
        let maxDateEgressCondition = formattedDate(new Date(inputDateEntryConverted), 0, 2);
    ...
    return (
        <>
            ...
            <div className="formRow">
                ...
                <div className="form-control-input">
                    <BeShowed show={props.data.reading}>
                        <input className="form-control" id="dateEmployee" readOnly type="time" ref={inputTimeEntry} defaultValue={props.data.date_entry} onChange={handleTimeEntry} />
                    </BeShowed>
                    <BeShowed show={!props.data.reading}>
                        <input className="form-control" id="dateEmployee" type="time" ref={inputTimeEntry} onChange={handleTimeEntry} defaultValue={props.data.date_entry} min={minTimeEntry} max={maxTimeEntry} />
                        <div style={{ color: 'red', fontFamily: 'Abel', fontWeight: 'bold' }} ref={divTimeEntryValidation} />
                    </BeShowed>
                </div>
            </div>
            ...
            <div className="formRow">
                ...
                <div className="form-control-input">
                    <BeShowed show={props.data.reading}>
                        <input className="form-control" id="dateEmployee" readOnly type="time" ref={inputTimeEgress} defaultValue={props.data.date_egress ? props.data.date_egress : 'null'} onChange={handleTimeEgress} />
                    </BeShowed>
                    <BeShowed show={!props.data.reading}>
                        <input className="form-control" id="dateEmployee" type="time" ref={inputTimeEgress} onChange={handleTimeEgress} defaultValue={props.data.date_egress ? props.data.date_egress : 'null'} min={minTimeEgress} max={maxTimeEgress} />
                        <div style={{ color: 'red', fontFamily: 'Abel', fontWeight: 'bold' }} ref={divTimeEgressValidation} />
                    </BeShowed>
                </div>
            </div>
        </>
