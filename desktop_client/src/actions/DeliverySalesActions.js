...
export const updateProductsXSuppliesDelivery = (array) => {
    return {
        type: 'UPDATE_PRODUCTS_X_SUPPLIES_DELIVERY',
        payload: array
    }
}

export const updateSuppliesDelivery = (array) => {
    return {
        type: 'UPDATE_SUPPLIES_DELIVERY',
        payload: array
    }
}