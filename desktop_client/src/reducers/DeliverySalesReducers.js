...
export const suppliesStocksDeliveryReducer = (state = [], action) => {
    if (action.type === 'UPDATE_DELIVERY_SUPPLIES_STOCKS') {
        return action.payload
    }
    return state
}

export const productsXsuppliesDeliveryReducer = (state = [], action) => {
    if (action.type === 'UPDATE_PRODUCTS_X_SUPPLIES_DELIVERY') {
        return action.payload
    }
    return state
}

export const suppliesDeliveryReducer = (state = [], action) => {
    if (action.type === 'UPDATE_SUPPLIES_DELIVERY') {
        return action.payload
    }
    return state
}